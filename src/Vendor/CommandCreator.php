...
class CommandCreator
{
     ...
     */
    public function create( string $name, string $path, string $className = null, string $type = 'Message', bool $create = false ) : string
    {
        ...
        $this->files->put(
            $path, $this->populateStub( $stub, $className, $type )
        );
     ...
     * @return string
     */
    protected function populateStub( $stub, $className, string $type ) : string
    {
    ...
    {
        return __DIR__ . '/../Contracts/Abstract/stubs';
    }
