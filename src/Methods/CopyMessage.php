...
class CopyMessage extends TelegramBase implements TelegramSenderContract
{
     ...
     * @return self
     */
    public static function create( int $message_id = 0, int | string $from_chat_id = '' ) : self
    {
    ...
    {
        return $this->telegram->copyMessage( $this->toArray() );
    }
